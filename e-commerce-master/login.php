...
//echo $pass;
//Database Connection
$conn = new mysqli('localhost/phpmyadmin','root@localhost','e-commerce');
...
<main class="container">
            <div class="bg-light p-5 rounded mt-3">
                <h2>Login Success</h2>
                <p class="lead">Now you can Order Foods from <a href="order.html">here</a>.</p>
            </div>
</main>                                                                     
...
<!--<h4>You made some Error please try again</h4>-->
